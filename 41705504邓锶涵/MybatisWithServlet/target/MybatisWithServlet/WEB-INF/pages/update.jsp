...
<table border="1" cellspacing="0">
    <form action="<%=request.getContextPath()%>/findById.do" method="post">
        <tr>
            <td>请先输入要更改的id:</td>
    ...
    <tr>
        <td colspan="2">以下是需要修改的学生信息(请先进行查询)</td>
    </tr>
    <form action="<%=request.getContextPath()%>/updateinfo.do" method="post">
        <tr>
            <td>学号:</td>
            <td><input type="text" name="studynum" value="${student.studynum}" /></td>
        </tr>
        <tr>
            <td>姓名:</td>
        ...
        <tr>
            <td><button class="bt" type="submit">更新</button></td>
            <td><button class="bt" type="reset">清空</button></td>
        </tr>
        <tr>
            <td colspan="2"><a href="index.jsp">返回</a></td>
        </tr>
        <input type="text" name="id" value="${student.id}" class="hi" />
    </form>
</table>
</body>
